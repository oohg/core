...
#command @ <row>, <col> SCROLLBAR <name> ;
      ...
      [ WIDTH <width> ] ;
      [ RANGE <min>, <max> ] ;
      [ <dummy02: ONCHANGE, ON CHANGE> <change> ] ;
      [ <dummy03: ONLINEUP, ONLINELEFT, ON LINEUP, ON LINELEFT> <lineup> ] ;
      [ <dummy04: ONLINEDOWN, ONLINERIGHT, ON LINEDOWN, ON LINERIGHT> <linedown> ] ;
      [ <dummy05: ONPAGEUP, ONPAGELEFT, ON PAGEUP, ON PAGELEFT> <pageup> ] ;
      [ <dummy06: ONPAGEDOWN, ONPAGERIGHT, ON PAGEDOWN, ON PAGERIGHT> <pagedown> ] ;
      [ <dummy07: ONTOP, ONLEFT, ON TOP, ON LEFT> <top> ] ;
      [ <dummy08: ONBOTTOM, ONRIGHT, ON BOTTOM, ON RIGHT> <bottom> ] ;
      [ <dummy09: ONTHUMB, ON THUMB> <thumb> ] ;
      [ <dummy10: ONTRACK, ON TRACK> <track> ] ;
      [ <dummy11: ONENDTRACK, ON ENDTRACK> <endtrack> ] ;
      [ HELPID <helpid> ] ;
      [ <invisible: INVISIBLE> ] ;
      [ TOOLTIP <tooltip> ] ;
      [ <rtl: RTL> ] ;
