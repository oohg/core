/*
 * $Id: i_checkbox.ch,v 1.1 2005-08-06 23:49:17 guerra000 Exp $
 */
/*
 * ooHG source code:
...
#command @ <row>,<col> CHECKBOX <name> ;
		...
		[ <notabstop: NOTABSTOP> ] ;
	=>;
	_DefineCheckBox ( <"name">, <"parent">, <col>, <row>, <caption>, <value> ,<f> ,<n> , <tooltip>  , <{change}>  , [<w>] , [<h>] , <{lostfocus}>, <{gotfocus}>  , <helpid>, <.invisible.>, <.notabstop.> ,<.bold.>, <.italic.>, <.underline.>, <.strikeout.> , <"field"> , <backcolor> , <fontcolor> , <.transparent.> )
