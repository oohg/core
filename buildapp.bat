...
:SYNTAX
   ...
   echo.
   echo    Options:
   echo       -sl      to suppress logging to error.log
   echo       -nr      to avoid run after build
   ...
   echo       -nohbc   to build without OOHG.HBC file
   echo       -norc    to build without OOHG resources
