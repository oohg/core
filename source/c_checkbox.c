/*
 * $Id: c_checkbox.c,v 1.1 2005-08-07 00:02:01 guerra000 Exp $
 */
/*
 * ooHG source code:
 * C checkbox functions
 *
...
HB_FUNC( INITCHECKBOX )
{
	...
	hbutton = CreateWindowEx( WS_EX_TRANSPARENT , "button" , hb_parc(2) ,
	Style ,
...
HB_FUNC( INITIMAGECHECKBUTTON )
{
	...
	hbutton = CreateWindow( "button" , hb_parc(2) ,
	Style	,
	hb_parni(4), hb_parni(5) ,hb_parni(9) ,hb_parni(10) ,
	hwnd,(HMENU)hb_parni(3) , GetModuleHandle(NULL) , NULL ) ;
