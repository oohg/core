@echo off
rem
rem $Id: common_make.bat,v 1.6 2007-05-14 02:24:45 guerra000 Exp $
rem
...
SET HG_FILES_C=c_ipaddress c_monthcal c_help c_crypt c_tree c_media c_combo c_controlmisc c_datepicker c_resource c_cursor c_ini c_font c_dialogs c_grid c_windows c_image c_listbox c_msgbox c_frame c_progressbar c_spinner c_textbox c_timer c_winapimisc c_scrsaver c_graph
