@echo off
rem
rem $Id: common_make.bat,v 1.9 2008-01-06 02:19:11 guerra000 Exp $
rem
...
SET HG_FILES_C=c_ipaddress c_monthcal c_help c_crypt c_media c_controlmisc c_datepicker c_resource c_cursor c_ini c_font c_dialogs c_grid c_windows c_image c_msgbox c_frame c_progressbar c_spinner c_textbox c_timer c_winapimisc c_scrsaver c_graph c_activex
