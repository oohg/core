@echo off
rem
rem $Id: common_make.bat,v 1.4 2007-03-31 02:06:11 guerra000 Exp $
rem
...
SET HG_FILES2_PRG=h_http h_comm h_print h_scroll h_splitbox h_progressmeter h_scrollbutton h_xbrowse h_internal h_textarray h_hotkeybox h_activex
