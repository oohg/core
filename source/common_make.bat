@echo off
rem
rem $Id: common_make.bat,v 1.15 2008-09-29 00:36:45 guerra000 Exp $
rem
...
SET HG_FILES_C=c_monthcal c_media c_controlmisc c_resource c_cursor c_font c_dialogs c_grid c_windows c_image c_msgbox c_progressbar c_spinner c_winapimisc c_scrsaver c_graph c_activex
