@echo off
rem
rem $Id: common_make.bat,v 1.18 2009-03-02 05:06:56 guerra000 Exp $
rem
...
SET HG_FILES2_PRG=h_graph h_richeditbox h_edit h_edit_ex h_scrsaver h_browse h_crypt h_zip h_http h_comm h_print h_scroll h_splitbox h_progressmeter h_scrollbutton h_xbrowse h_internal h_textarray h_hotkeybox h_activex h_pdf h_hotkey h_hyperlink h_tooltip h_picture
SET HG_FILES_C=c_media c_controlmisc c_resource c_cursor c_font c_dialogs c_grid c_windows c_image c_msgbox c_progressbar c_spinner c_winapimisc c_scrsaver c_graph c_activex
