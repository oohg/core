...
function ABM2( cArea, cTitulo, aNombreCampo, ;
   ...
   if ( ! ValType( cArea ) $ "CM" ) .or. Empty( cArea )
      _cArea := Alias()
      if _cArea == ""
         MsgExclamation( _OOHG_Messages( MT_EXT_USR, 1 ), "EDIT EXTENDED" )
         return NIL
      endif
   else
      _cArea := cArea
   ...
   if !lSalida
      ...
      for i := 1 to Len( _aEstructura )
         ...
         case _aEstructura[i,DBS_TYPE] == "C"
            aAdd( aAvisoCampo, _OOHG_Messages( MT_EXT_USR, 2 ) )
         case _aEstructura[i,DBS_TYPE] == "N"
            aAdd( aAvisoCampo, _OOHG_Messages( MT_EXT_USR, 3 ) )
         case _aEstructura[i,DBS_TYPE] == "D"
            aAdd( aAvisoCampo, _OOHG_Messages( MT_EXT_USR, 4 ) )
         case _aEstructura[i,DBS_TYPE] == "L"
            aAdd( aAvisoCampo, _OOHG_Messages( MT_EXT_USR, 5 ) )
         case _aEstructura[i,DBS_TYPE] == "M"
            aAdd( aAvisoCampo, _OOHG_Messages( MT_EXT_USR, 6 ) )
         otherwise
            aAdd( aAvisoCampo, _OOHG_Messages( MT_EXT_USR, 7 ) )
         endcase
      next
   endif
   ...
   **** END JK 104
   ...
   _aIndiceCampo := {}
   nVeces        := 1
   aAdd( _aIndice, _OOHG_Messages( MT_EXT_LBL, 1 ) )
   ...
   define window wndABM2Edit               ;
      ...
      define statusbar font "ms sans serif" size 9
            statusitem _OOHG_Messages( MT_EXT_LBL, 19 )                       // 1
            statusitem _OOHG_Messages( MT_EXT_LBL, 20 )     width 100 raised  // 2
            statusitem _OOHG_Messages( MT_EXT_LBL, 2 ) +': '     width 200 raised // 3
      end statusbar

      // Define la barra de botones de la ventana de visualización.
      define toolbar tbEdit buttonsize 90, 32 flat righttext border
         button tbbCerrar  caption _OOHG_Messages( MT_EXT_BTN, 1 ) ;
                           picture "MINIGUI_EDIT_CLOSE"          ;
                           action  wndABM2Edit.Release
         button tbbNuevo   caption _OOHG_Messages( MT_EXT_BTN, 2 ) ;
                           picture "MINIGUI_EDIT_NEW"            ;
                           action  {|| ABM2Editar( .t. ) }
         button tbbEditar  caption _OOHG_Messages( MT_EXT_BTN, 3 ) ;
                           picture "MINIGUI_EDIT_EDIT"           ;
                           action  {|| ABM2Editar( .f. ) }
         button tbbBorrar  caption _OOHG_Messages( MT_EXT_BTN, 4 ) ;
                           picture "MINIGUI_EDIT_DELETE"         ;
                           action  {|| ABM2Borrar() }
         button tbbBuscar  caption _OOHG_Messages( MT_EXT_BTN, 5 ) ;
                           picture "MINIGUI_EDIT_FIND"           ;
                           action  {|| ABM2Buscar() }
         button tbbListado caption _OOHG_Messages( MT_EXT_BTN, 6 ) ;
   ...
   @ 60, 20 label lblIndice               ;
            of wndABM2Edit                  ;
            value _OOHG_Messages( MT_EXT_USR, 26 )  ;
            width 150                       ;
            height 25                       ;
            font "ms sans serif" size 9
   ...
   @ 60, nColumna label lblOpciones        ;
            of wndABM2Edit                  ;
            value _OOHG_Messages( MT_EXT_LBL, 5 )   ;
            width 150                       ;
            height 25                       ;
            font "ms sans serif" size 9
   ...
   @ 65, (wndABM2Edit.Width / 2)-110 button btnFiltro1     ;
            of wndABM2Edit                                  ;
            caption _OOHG_Messages( MT_EXT_BTN, 10 )                 ;
   ...
   @ 65, (wndABM2Edit.Width / 2)+5 button btnFiltro2       ;
            of wndABM2Edit                                  ;
            caption _OOHG_Messages( MT_EXT_BTN, 11 )                 ;
...
static function ABM2Redibuja( lTabla )
   ...
   wndABM2Edit.StatusBar.Item( 1 ) := _OOHG_Messages( MT_EXT_LBL, 19 ) + _cFiltro
   wndABM2Edit.StatusBar.Item( 2 ) := _OOHG_Messages( MT_EXT_LBL, 20 ) + iif( _lFiltro, _OOHG_Messages( MT_EXT_USR, 29 ), _OOHG_Messages( MT_EXT_USR, 30 ) )
   wndABM2Edit.StatusBar.Item( 3 ) := _OOHG_Messages( MT_EXT_LBL, 2 ) + ': '+                                  ;
...
static function ABM2Editar( lNuevo )
   ...
   cTitulo     := iif( lNuevo, _OOHG_Messages( MT_EXT_LBL, 6 ), _OOHG_Messages( MT_EXT_LBL, 7 ) )
   ...
   define window wndABM2EditNuevo                                  ;
      ...
      define splitbox
         ...
         define toolbar tbEditNuevo buttonsize 90, 32 flat righttext
            button tbbCancelar caption _OOHG_Messages( MT_EXT_BTN, 7 ) ;
                               picture "MINIGUI_EDIT_CANCEL"        ;
                               action  wndABM2EditNuevo.Release
            button tbbAceptar  caption _OOHG_Messages( MT_EXT_BTN, 8 ) ;
                               picture "MINIGUI_EDIT_OK"            ;
                               action  ABM2EditarGuardar( lNuevo )
            button tbbCopiar   caption _OOHG_Messages( MT_EXT_BTN, 9 ) ;
...
static function ABM2Seleccionar()
   ...
   define window wndSeleccionar            ;
         ...
         width 500                       ;
         height 300                      ;
         title _OOHG_Messages( MT_EXT_LBL, 8 )   ;
         modal                           ;
         nosize                          ;
         nosysmenu                       ;
         font "ms sans serif" size 9     ;
         ...
         define toolbar tbSeleccionar buttonsize 90, 32 flat righttext border
               button tbbCancelarSel caption _OOHG_Messages( MT_EXT_BTN, 7 ) ;
                                     picture "MINIGUI_EDIT_CANCEL"             ;
                                     action  {|| lSalida := .f.,               ;
                                     nReg    := 0,                 ;
                                     wndSeleccionar.Release }
               button tbbAceptarSel  caption _OOHG_Messages( MT_EXT_BTN, 8 ) ;
                                     picture "MINIGUI_EDIT_OK"                                         ;
                                     action  {|| lSalida := .t.,                                       ;
         ...
         define statusbar font "ms sans serif" size 9
                  statusitem _OOHG_Messages( MT_EXT_USR, 7 )
         end statusbar
...
static function ABM2Borrar()
   ...
   if MsgOKCancel( _OOHG_Messages( MT_EXT_USR, 8 ), _OOHG_Messages( MT_EXT_LBL, 16 ) )
      if (_cArea)->( rlock() )
         (_cArea)->( dbDelete() )
         (_cArea)->( dbCommit() )
         (_cArea)->( dbunlock() )
         ...
         Msgstop( _OOHG_Messages( MT_EXT_USR, 41 ), _cTitulo )
         wndabm2edit.tbbNuevo.enabled:=.t.
         wndabm2edit.tbbEditar.enabled:=.t.
         wndabm2edit.tbbBorrar.enabled:=.t.
         wndabm2edit.tbbBuscar.enabled:=.t.
...
static function ABM2Buscar()
   ...
   if _nIndiceActivo == 1
      msgExclamation( _OOHG_Messages( MT_EXT_USR, 9 ), _cTitulo )
      wndabm2edit.tbbNuevo.enabled:=.t.
      wndabm2edit.tbbEditar.enabled:=.t.
      wndabm2edit.tbbBorrar.enabled:=.t.
      wndabm2edit.tbbBuscar.enabled:=.t.
   ...
   if _aEstructura[nControl,DBS_TYPE] == "L" .or. _aEstructura[nControl,DBS_TYPE] == "M"
      msgExclamation( _OOHG_Messages( MT_EXT_USR, 10 ), _cTitulo )
      wndabm2edit.tbbNuevo.enabled:=.t.
      wndabm2edit.tbbEditar.enabled:=.t.
      wndabm2edit.tbbBorrar.enabled:=.t.
      wndabm2edit.tbbBuscar.enabled:=.t.
   ...
   define window wndABMBuscar              ;
         ...
         width 500                       ;
         height 170                      ;
         title _OOHG_Messages( MT_EXT_LBL, 9 )   ;
         modal                           ;
         nosize                          ;
         nosysmenu                       ;
         font "ms sans serif" size 9     ;
         ...
         define toolbar tbBuscar buttonsize 90, 32 flat righttext border
            button tbbCancelarBus caption _OOHG_Messages( MT_EXT_BTN, 7 ) ;
                                  picture "MINIGUI_EDIT_CANCEL"                     ;
                                  action  {|| lSalida := .f.,                       ;
                                          xValor := wndABMBuscar.conBuscar.Value,  ;
                                          wndABMBuscar.Release }
            button tbbAceptarBus  caption _OOHG_Messages( MT_EXT_BTN, 8 ) ;
                                  picture "MINIGUI_EDIT_OK"                         ;
                                  action  {|| lSalida := .t.,                       ;
                                          xValor := wndABMBuscar.conBuscar.Value,  ;
                                          wndABMBuscar.Release }
   ...
   if lSalida
      ...
      if !lResultado
         msgExclamation( _OOHG_Messages( MT_EXT_USR, 11 ), _cTitulo )
         (_cArea)->( dbGoTo( nRegistro ) )
      else
         ABM2Redibuja( .t. )
      endif
...
static function ABM2ActivarFiltro()
   ...
   if _cFiltro != ""
      MsgInfo( _OOHG_Messages( MT_EXT_USR, 34 ), '' )
   endif

   ////////// Inicialización de variables.----------------------------------------
   aCampos    := _aNombreCampo
   aCompara   := { _OOHG_Messages( MT_EXT_LBL, 27 ),;
                   _OOHG_Messages( MT_EXT_LBL, 28 ),;
                   _OOHG_Messages( MT_EXT_LBL, 29 ),;
                   _OOHG_Messages( MT_EXT_LBL, 30 ),;
                   _OOHG_Messages( MT_EXT_LBL, 31 ),;
                   _OOHG_Messages( MT_EXT_LBL, 32 ) }
   ...
   define window wndABM2Filtro                     ;
         ...
         width 400                               ;
         height 325                              ;
         title _OOHG_Messages( MT_EXT_LBL, 21 )          ;
         modal                                   ;
         nosize                                  ;
         nosysmenu                               ;
         ...
         define toolbar tbBuscar buttonsize 90, 32 flat righttext border
                button tbbCancelarFil caption _OOHG_Messages( MT_EXT_BTN, 7 ) ;
                                      picture "MINIGUI_EDIT_CANCEL"     ;
                                      action  {|| wndABM2Filtro.Release,;
                                      ABM2Redibuja( .f. ) }
                 button tbbAceptarFil  caption _OOHG_Messages( MT_EXT_BTN, 8 ) ;
                                      picture "MINIGUI_EDIT_OK"         ;
   ...
   @ 65, 20 label lblCampos                ;
                of wndABM2Filtro                ;
                value _OOHG_Messages( MT_EXT_LBL, 22 )  ;
                width 140                       ;
                height 25                       ;
                font "ms sans serif" size 9
   @ 65, 220 label lblCompara              ;
                of wndABM2Filtro                ;
                value _OOHG_Messages( MT_EXT_LBL, 23 )  ;
                width 140                       ;
                height 25                       ;
                font "ms sans serif" size 9
   @ 200, 20 label lblValor                ;
                of wndABM2Filtro                ;
                value _OOHG_Messages( MT_EXT_LBL, 24 )  ;
                width 140                       ;
                height 25                       ;
                font "ms sans serif" size 9
   @ 85, 20 listbox lbxCampos                      ;
                ...
                on gotfocus wndABM2Filtro.StatusBar.Item(1) := _OOHG_Messages( MT_EXT_LBL, 25 ) ;
   ...
   @ 85, 220 listbox lbxCompara                    ;
                ...
                value 1                                 ;
                font "Arial" size 9                     ;
                on gotfocus wndABM2Filtro.StatusBar.Item(1) := _OOHG_Messages( MT_EXT_LBL, 26 ) ;
                on lostfocus wndABM2Filtro.StatusBar.Item(1) := ""
...
static function ABM2ControlFiltro()
   ...
   if _aEstructura[nControl,DBS_TYPE] == "M"
      msgExclamation( _OOHG_Messages( MT_EXT_USR, 35 ), _cTitulo )
      wndabm2edit.tbbNuevo.enabled:=.t.
      wndabm2edit.tbbEditar.enabled:=.t.
      wndabm2edit.tbbBorrar.enabled:=.t.
      wndabm2edit.tbbBuscar.enabled:=.t.
   ...
   if nControl == 0
      msgExclamation( _OOHG_Messages( MT_EXT_USR, 36 ), _cTitulo )
      wndabm2edit.tbbNuevo.enabled:=.t.
      wndabm2edit.tbbEditar.enabled:=.t.
      wndabm2edit.tbbBorrar.enabled:=.t.
      wndabm2edit.tbbBuscar.enabled:=.t.
...
static function ABM2EstableceFiltro()
   ...
   if nCompara == 0
      msgExclamation( _OOHG_Messages( MT_EXT_USR, 37 ), _cTitulo )
      wndabm2edit.tbbNuevo.enabled:=.t.
      wndabm2edit.tbbEditar.enabled:=.t.
      wndabm2edit.tbbBorrar.enabled:=.t.
      wndabm2edit.tbbBuscar.enabled:=.t.
   ...
   if cValor == ""
      msgExclamation( _OOHG_Messages( MT_EXT_USR, 38 ), _cTitulo )
      wndabm2edit.tbbNuevo.enabled:=.t.
      wndabm2edit.tbbEditar.enabled:=.t.
      wndabm2edit.tbbBorrar.enabled:=.t.
      wndabm2edit.tbbBuscar.enabled:=.t.
...
static function ABM2DesactivarFiltro()
   ...
   if !_lFiltro
      msgExclamation( _OOHG_Messages( MT_EXT_USR, 39 ), _cTitulo )
      ABM2Redibuja( .f. )
      wndabm2edit.tbbNuevo.enabled:=.t.
      wndabm2edit.tbbEditar.enabled:=.t.
      wndabm2edit.tbbBorrar.enabled:=.t.
   ...
   if msgYesNo( _OOHG_Messages( MT_EXT_USR, 40 ), _cTitulo )
...
static function ABM2Imprimir()
   ...
   define window wndABM2Listado            ;
          ...
          width 390                       ;
          height 365                      ;
          title _OOHG_Messages( MT_EXT_LBL, 10 )  ;
          ...
          define toolbar tbListado buttonsize 90, 32 flat righttext border
                        button tbbCancelarLis caption _OOHG_Messages( MT_EXT_BTN, 7 ) ;
                                              picture "MINIGUI_EDIT_CANCEL"             ;
                                              action  wndABM2Listado.Release
                        button tbbAceptarLis  caption _OOHG_Messages( MT_EXT_BTN, 8 ) ;
                                              picture "MINIGUI_EDIT_OK"                 ;
   ...
   @ 65, 20 label lblCampoBase             ;
                of wndABM2Listado               ;
                value _OOHG_Messages( MT_EXT_LBL, 11 )  ;
                width 140                       ;
                height 25                       ;
                font "ms sans serif" size 9
   @ 65, 220 label lblCampoListado         ;
                of wndABM2Listado               ;
                value _OOHG_Messages( MT_EXT_LBL, 12 )  ;
                width 140                       ;
                height 25                       ;
                font "ms sans serif" size 9
   @ 200, 20 label lblImpresoras           ;
                of wndABM2Listado               ;
                value _OOHG_Messages( MT_EXT_LBL, 13 )  ;
                width 140                       ;
                height 25                       ;
                font "ms sans serif" size 9
   @ 200, 170 label lblInicial             ;
                of wndABM2Listado               ;
                value _OOHG_Messages( MT_EXT_LBL, 14 )  ;
                width 160                       ;
                height 25                       ;
                font "ms sans serif" size 9
   @ 255, 170 label lblFinal               ;
                of wndABM2Listado               ;
                value _OOHG_Messages( MT_EXT_LBL, 15 )  ;
                width 160                       ;
                height 25                       ;
                font "ms sans serif" size 9
   ...
   @ 85, 20 listbox lbxCampoBase                                           ;
                ...
                value 1                                                         ;
                font "Arial" size 9                                             ;
                on gotfocus wndABM2Listado.StatusBar.Item( 1 ) := _OOHG_Messages( MT_EXT_USR, 12 ) ;
   ...
   @ 85, 220 listbox lbxCampoListado                                       ;
                ...
                value 1                                                         ;
                font "Arial" size 9                                             ;
                on gotFocus wndABM2Listado.StatusBar.Item( 1 ) := _OOHG_Messages( MT_EXT_USR, 13 ) ;
                on lostfocus wndABM2Listado.StatusBar.Item( 1 ) := ""
   ...
   @ 220, 20 combobox cbxImpresoras                                        ;
                ...
                width 140                                                       ;
                font "Arial" size 9                                             ;
                on gotfocus wndABM2Listado.StatusBar.Item( 1 ) := _OOHG_Messages( MT_EXT_USR, 14 ) ;
                on lostfocus wndABM2Listado.StatusBar.Item( 1 ) := ""
   ...
   @ 90, 170 button btnMas                                                 ;
                ...
                width 40                                                        ;
                height 40                                                       ;
                on gotfocus wndABM2Listado.StatusBar.Item( 1 ) := _OOHG_Messages( MT_EXT_USR, 15 ) ;
                on lostfocus wndABM2Listado.StatusBar.Item( 1 ) := ""
   @ 140, 170 button btnMenos                                              ;
                ...
                width 40                                                        ;
                height 40                                                       ;
                on gotfocus wndABM2Listado.StatusBar.Item( 1 ) := _OOHG_Messages( MT_EXT_USR, 16 ) ;
                on lostfocus wndABM2Listado.StatusBar.Item( 1 ) := ""
   @ 220, 170 button btnSet1                                               ;
                ...
                width 25                                                        ;
                height 25                                                       ;
                on gotfocus wndABM2Listado.StatusBar.Item( 1 ) := _OOHG_Messages( MT_EXT_USR, 17 ) ;
                on lostfocus wndABM2Listado.StatusBar.Item( 1 ) := ""
   @ 275, 170 button btnSet2                                               ;
                ...
                width 25                                                        ;
                height 25                                                       ;
                on gotfocus wndABM2Listado.StatusBar.Item( 1 ) := _OOHG_Messages( MT_EXT_USR, 18 ) ;
                on lostfocus wndABM2Listado.StatusBar.Item( 1 ) := ""

   // CheckBox.
   @ 255, 20 checkbox chkVistas            ;
                of wndABM2Listado               ;
                caption _OOHG_Messages( MT_EXT_LBL, 18 ) ;
                width 140                       ;
                height 25                       ;
                value .t.                       ;
                font "ms sans serif" size 9
   @ 275, 20 checkbox chkPrevio            ;
                of wndABM2Listado               ;
                caption _OOHG_Messages( MT_EXT_LBL, 17 ) ;
                width 140                       ;
                height 25                       ;
                value .t.                       ;
                font "ms sans serif" size 9
...
static function ABM2DefinirColumnas( nAccion )
   ...
   case nAccion == ABM_LIS_ADD
      ...
      if Len( aCampoBase ) == 0
         msgExclamation( _OOHG_Messages( MT_EXT_USR, 23 ), _cTitulo )
         wndabm2edit.tbbNuevo.enabled:=.t.
         wndabm2edit.tbbEditar.enabled:=.t.
         wndabm2edit.tbbBorrar.enabled:=.t.
         wndabm2edit.tbbBuscar.enabled:=.t.
...
static function ABM2Listado( aImpresoras )
   ...
   if nImpresora == 0
      msgExclamation( _OOHG_Messages( MT_ABM_LBL, 32 ), _cTitulo )
   else
   ...
   next
   if Len( aCampo ) == 0
      msgExclamation( _OOHG_Messages( MT_ABM_LBL, 23 ), _cTitulo )
      wndabm2edit.tbbNuevo.enabled:=.t.
      wndabm2edit.tbbEditar.enabled:=.t.
      wndabm2edit.tbbBorrar.enabled:=.t.
      wndabm2edit.tbbBuscar.enabled:=.t.
   ...
   next
   if nAncho > 164
      MsgExclamation( _OOHG_Messages( MT_ABM_LBL, 24 ), _cTitulo )
      wndabm2edit.tbbNuevo.enabled:=.t.
      wndabm2edit.tbbEditar.enabled:=.t.
      wndabm2edit.tbbBorrar.enabled:=.t.
      wndabm2edit.tbbBuscar.enabled:=.t.
   ...
   do while lSalida
      ...
      for i := 1 to Len( aNumeroCampo )
         ...
         case _aEstructura[nCampo,DBS_TYPE] == "L"
            oprint:printdata(nfila,ncolumna+1, iif( (_cArea)->( FieldGet( aNumeroCampo[i] ) ), _OOHG_Messages( MT_ABM_LBL, 29 ), _OOHG_Messages( MT_ABM_LBL, 30 ) )   ) ///
         case _aEstructura[nCampo,DBS_TYPE] == "M"
      ...
      if lOrientacion
         if nFila > 44
            ...
            cPie := _OOHG_Messages( MT_ABM_LBL, 22 ) + " " + ;
            AllTrim( Str( nPagina) )
