@echo off
rem
rem $Id: makelib.bat,v 1.26 2006-07-27 04:17:44 guerra000 Exp $
rem
cls
...
%hg_hrb%\bin\harbour h_http h_comm h_print h_scroll h_splitbox h_progressmeter h_scrollbutton h_xbrowse h_internal %OOHG_X_FLAGS%
if errorlevel 1 goto EXIT1
