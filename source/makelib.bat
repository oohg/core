@echo off
rem
rem $Id: makelib.bat,v 1.24 2006-07-05 02:36:17 guerra000 Exp $
rem
cls
...
%hg_hrb%\bin\harbour h_http h_comm h_print h_scroll h_splitbox h_progressmeter h_scrollbutton h_xbrowse %OOHG_X_FLAGS%
if errorlevel 1 goto EXIT1
