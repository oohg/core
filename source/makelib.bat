...
:DETECT_HM30
   ...
   if     exist "%HG_START_DP_MAKELIB_BAT%\MakeLib3264.bat" goto SYNTAX
   if     exist "%HG_START_DP_MAKELIB_BAT%\MakeLib34.bat"   goto SYNTAX
   if     exist "%HG_START_DP_MAKELIB_BAT%\MakeLib3464.bat" goto SYNTAX
...
:DETECT_HM32
   ...
   if not exist "%HG_START_DP_MAKELIB_BAT%\MakeLib32.bat"   goto DETECT_HM3264
   if     exist "%HG_START_DP_MAKELIB_BAT%\MakeLib3264.bat" goto SYNTAX
   if     exist "%HG_START_DP_MAKELIB_BAT%\MakeLib34.bat"   goto SYNTAX
   if     exist "%HG_START_DP_MAKELIB_BAT%\MakeLib3464.bat" goto SYNTAX
   if     exist "%HG_START_DP_MAKELIB_BAT%\MakeLibXB.bat"   goto SYNTAX
...
:DETECT_HM3264
   ...
   if not exist "%HG_START_DP_MAKELIB_BAT%\MakeLib3264.bat" goto DETECT_HM34
   if     exist "%HG_START_DP_MAKELIB_BAT%\MakeLib34.bat"   goto SYNTAX
   if     exist "%HG_START_DP_MAKELIB_BAT%\MakeLib3464.bat" goto SYNTAX
   if     exist "%HG_START_DP_MAKELIB_BAT%\MakeLibXB.bat"   goto SYNTAX
   if     exist "%HG_START_DP_MAKELIB_BAT%\MakeLibXM.bat"   goto SYNTAX
...
:DETECT_HM34
   ...
   if not exist "%HG_START_DP_MAKELIB_BAT%\MakeLib34.bat"   goto DETECT_HM3464
   if     exist "%HG_START_DP_MAKELIB_BAT%\MakeLib3464.bat" goto SYNTAX
   if     exist "%HG_START_DP_MAKELIB_BAT%\MakeLibXB.bat"   goto SYNTAX
   if     exist "%HG_START_DP_MAKELIB_BAT%\MakeLibXM.bat"   goto SYNTAX
   goto MAKELIB_HM34
...
:DETECT_HM3464
   ...
   if not exist "%HG_START_DP_MAKELIB_BAT%\MakeLib3464.bat" goto DETECT_XB
   if     exist "%HG_START_DP_MAKELIB_BAT%\MakeLibXB.bat"   goto SYNTAX
   if     exist "%HG_START_DP_MAKELIB_BAT%\MakeLibXM.bat"   goto SYNTAX
   goto MAKELIB_HM3464
...
:DETECT_XM
   ...
   echo File %HG_START_DP_MAKELIB_BAT%\MakeLib3264.bat not found !!!
   echo File %HG_START_DP_MAKELIB_BAT%\MakeLib34.bat not found !!!
   echo File %HG_START_DP_MAKELIB_BAT%\MakeLib3464.bat not found !!!
...
:TEST_HM3264
   ...
   shift
   if exist "%HG_START_DP_MAKELIB_BAT%\MakeLib3264.bat" goto MAKELIB_HM3264
   echo File %HG_START_DP_MAKELIB_BAT%\MakeLib3264.bat not found !!!
   echo.
   echo This file must be executed from SOURCE folder !!!
   echo.
...
:TEST_HM3464
   ...
   shift
   if exist "%HG_START_DP_MAKELIB_BAT%\MakeLib3464.bat" goto MAKELIB_HM3464
   echo File %HG_START_DP_MAKELIB_BAT%\MakeLib3464.bat not found !!!
   echo.
   echo This file must be executed from SOURCE folder !!!
   echo.
