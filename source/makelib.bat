@echo off
rem
rem $Id: makelib.bat,v 1.31 2006-11-01 04:07:05 guerra000 Exp $
rem
cls
...
%hg_hrb%\bin\harbour h_http h_comm h_print h_scroll h_splitbox h_progressmeter h_scrollbutton h_xbrowse h_internal h_textarray h_hotkeybox %OOHG_X_FLAGS%
if errorlevel 1 goto EXIT1
