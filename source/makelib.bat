@echo off
rem
rem $Id: makelib.bat,v 1.17 2006-03-26 21:32:25 guerra000 Exp $
rem
cls
...
:XHARBOUR_COMPILE
%hg_hrb%\bin\harbour h_browse h_scrsaver h_error h_ipaddress h_monthcal h_help h_crypt h_status h_tree h_toolbar errorsys h_init h_media h_winapimisc h_slider h_button h_checkbox h_combo h_controlmisc h_datepicker h_editbox h_dialogs h_grid h_windows h_image h_label h_listbox h_menu h_msgbox h_frame h_progressbar h_radio h_spinner h_tab h_textbox h_timer h_cursor h_ini h_report h_registry h_font h_hyperlink h_hotkey h_graph h_richeditbox h_edit h_edit_ex h_scroll h_http h_zip h_progressmeter h_comm h_print -i%hg_hrb%\include;%hg_root%\include; -n1 -w2 -gc0 -es2
if errorlevel 1 goto EXIT1
