 ...
 * Picture control
 *
 * Copyright 2009-2019 Vicente Guerra <vicente@guerra.com.mx> and contributors of
...
HB_FUNC( INITPICTURECONTROL )
{
   ...
   _OOHG_PictureControl_lpfnOldWndProc( ( WNDPROC ) SetWindowLongPtr( hCtrl, GWL_WNDPROC, ( LONG_PTR ) SubClassFunc ) );
