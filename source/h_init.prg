/*
 * $Id: h_init.prg,v 1.12 2006-02-28 15:51:18 declan2005 Exp $
 */
/*
 * ooHG source code:
...
INIT PROCEDURE _OOHG_INIT()
   ...
   _OOHG_THISItemCellValue := Nil
    ...
    _OOHG_TooltipBackColor := Nil

    _OOHG_TooltipForeColor  := NIL
...
Local acButton, acLabel, acUser
   ...
   acBrowseError := { "Fenêtre: "                                             ,;
                      ...
                      "Erreur"                                                ,;
                      "Entrée invalide"                                        }
   acBrowseMessages := { 'Etes-vous sûre ?' , 'Enregistrement détruit' }
...
Local acButton, acLabel, acUser
   ...
   acBrowseButton := {}
   acBrowseError := {}
   acBrowseMessages := { 'Sind Sie sicher ?' , 'Datensatz löschen' }
...
Local acButton, acLabel, acUser
   ...
   acBrowseError := { "Window: "                                              ,;
                      ...
                      "Aguarde..."                                            ,;
                      "Dado Invalido"                                          }
   acBrowseMessages := { 'Você tem Certeza ?' , 'Apaga Registro' }
...
Local acButton, acLabel, acUser
   ...
   acBrowseMessages := { 'Âû óâåðåíû ?' , 'Óäàëèòü çàïèñü' }
...
Local acButton, acLabel, acUser
   ...
   acBrowseError := { "Window: "                                              ,;
                      ...
                      "Browse: La cláusula APPEND no puede ser usada con campos no pertenecientes al area del BROWSE. Ejecución terminada",;
                      "El registro está siendo editado por otro usuario"      ,;
                      "Peligro"                                               ,;
                      "Entrada no válida"                                      }
   acBrowseMessages := { '¿ Está Seguro ?' , 'Eliminar Registro' }
...
Local acButton, acLabel, acUser
   ...
   acBrowseError := { "Window: "                        ,;
                      ...
                      "Opozorilo"                            ,;
                      "Narobe vnos" }
   acBrowseMessages := { 'Ste preprièani ?' , 'Briši vrstico' }
