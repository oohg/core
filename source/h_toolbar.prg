...
{
   return _OOHG_WndProcCtrl( hWnd, msg, wParam, lParam, _OOHG_TToolbar_lpfnOldWndProc( 0 ) );
}
...
HB_FUNC( INITTOOLBAR )
{
   ...
   TbStyleEx = TBSTYLE_EX_DRAWDDARROWS;
   ...
   hwndTB = CreateWindowEx( StyleEx, TOOLBARCLASSNAME, NULL, Style,
                            0, 0, 0, 0,
