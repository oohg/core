/*
 * $Id: h_activex.prg,v 1.3 2007-09-10 21:40:15 declan2005 Exp $ 
 */ 
/* 
 * ooHG source code: 
 * ActiveX control 
...
static function _dummycall() 
return SHUTDOWNCONNECTIONPOINT() 
...
//   #define __USEHASHEVENTS 
   ...
   HB_FUNC_STATIC( SETUPCONNECTIONPOINT ) 
   { 
   ...
   //------------------------------------------------------------------------------ 
   HB_FUNC_STATIC( SHUTDOWNCONNECTIONPOINT ) 
   { 
